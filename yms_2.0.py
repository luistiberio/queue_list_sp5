...
def update_packing_google_sheets(csv_file_path):
    try:
        ...
        sheet1 = client.open_by_url("https://docs.google.com/spreadsheets/d/1SKPZeVgW84z2q7vTbLsVRq75iex0fvZ4xD_v5mIOxFM/edit?gid=1360806683#gid=1360806683")
        worksheet1 = sheet1.worksheet("Queue List SPX")
